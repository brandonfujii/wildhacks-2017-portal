        ...
        return (
            <div className="home relative w-100 overflow-hidden">
                ...
                <footer className="pv6 ph4 relative z-9999">
                    ...
                    <p className="karla white f5 tc antialias">As an MLH sanctioned event, WildHacks adheres to and enforces the <a className="link wh-sand underline antialias" href="https://static.mlh.io/docs/mlh-code-of-conduct.pdf" target="_blank" rel="noopener noreferrer">MLH Code of Conduct.</a></p>
                </footer>
            </div>
        );
    }
